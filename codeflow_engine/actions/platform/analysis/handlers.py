...
from codeflow_engine.actions.platform_detection.analysis.base import FileAnalysisResult
from codeflow_engine.actions.platform_detection.analysis.patterns import (
    ContentPattern,
    FilePattern,
)
...
if TYPE_CHECKING:
    from codeflow_engine.actions.platform_detection.analysis.base import FileAnalyzer
