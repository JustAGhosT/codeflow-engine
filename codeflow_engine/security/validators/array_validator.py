"""
Array Validator - Backwards compatibility module.
...
from codeflow_engine.core.validation.validators import ArrayTypeValidator
from codeflow_engine.core.validation import ValidationResult, ValidationSeverity


# Legacy alias for backwards compatibility
ArrayValidator = ArrayTypeValidator

__all__ = ["ArrayValidator", "ArrayTypeValidator", "ValidationResult", "ValidationSeverity"]
