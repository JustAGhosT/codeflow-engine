...
class AILintingFixerInputs(BaseModel):
    ...
    quiet: bool = Field(default=False, description="Whether to run in quiet mode")
    verbose_metrics: bool = Field(
        default=False, description="Whether to show verbose metrics"
    )
