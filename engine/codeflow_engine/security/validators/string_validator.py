"""
String Validator - Backwards compatibility module.
...
from codeflow_engine.core.validation.validators import StringTypeValidator
from codeflow_engine.core.validation import ValidationResult, ValidationSeverity


# Legacy alias for backwards compatibility
StringValidator = StringTypeValidator

__all__ = ["StringValidator", "StringTypeValidator", "ValidationResult", "ValidationSeverity"]
