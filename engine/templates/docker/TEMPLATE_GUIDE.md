# CodeFlow Docker Template Guide

## Overview

This guide explains how to create and maintain Docker templates for the CodeFlow template system.
...
examples:
  - name: "Basic Usage"
    ...
    command: "CodeFlow generate docker --template node"
  - name: "With PM2"
    description: "Generate with PM2 process manager"
    command: "CodeFlow generate docker --template node --variant with_pm2"
...
```dockerfile
# {{ template_info.name }}
# Generated by CodeFlow - DO NOT EDIT DIRECTLY
...
1. **Test variable substitution**:
   ...
   CodeFlow generate docker --template your-template --test
   ```
