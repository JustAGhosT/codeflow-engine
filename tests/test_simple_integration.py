#!/usr/bin/env python3
"""
Simple Integration Test for AI Enhanced File Splitter

This test demonstrates the core integration of the file splitter
...
async def test_core_integration():
    ...
    large_file_content = '''
"""
Large test module with multiple functions.
"""
...
'''
    ...
    file_path = create_test_file_with_issues(large_file_content, "large_test_file.py")
    ...
    try:
        ...
        # Create mock LLM manager with minimal config
        llm_config = {
            "providers": {},
        ...
        try:
            ...
            for component_file in Path(file_path).parent.glob(
